...
<body>
	...
	if($new_row=mysqli_fetch_array($new_result)){
		echo "<br><center><font size=8face=楷体_GB2312 color=#008000>水稻生长信息——土壤环境</font></center>";
	...
	echo "<script>alert('无记录！');location.href='TuRangShuJu.php';</script>";
	?>
</body>
</html>