...
<body>
  <div align = "center">
         <font size = "5" color = "#008000"><b>空气温度查询</b></font>
      </div>
      <form name = "frm1" method = "post" action = "kqwdtx.php" style = "margin:0">
         <table width = "360" align = "center">
         <tr>
            <td width = "200"><span class = "STYLE1">根据日期查询空气温度信息:</span></td>
            <td>
   ...
   <?php 
     require "fun.php";
      ...
      $a=array();
      $a2 = array();
      $sql1 = mysqli_query($conn,"select kqwd from kqsj where rq like '$sj %'");
